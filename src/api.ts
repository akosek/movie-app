...
//export const API_URL_POPULAR = 'https://imdb-api.com/en/API/MostPopularMovies/k_bf5qzpn2/?limit=5';
export const MOVIE_DETAILS = 'https://imdb-api.com/en/API/Title/k_bf5qzpn2/';

//Bring it back when API calls allowed again
//export const MOVIE_DETAILS = 'https://imdb-api.com/en/API/Title/k_sdye50vh/';
